    ...
    if 'button_search' in changed_id:
        last_column = html.Div(
            [
                ...
                dbc.Tooltip(
                    html.P('За совпадение группы/потока/института даётся по 1-му баллу, т.е. если человек из твоей группы, то ему присуждается +3 балла'),
                    html.Br(),
                    html.P('За каждое совпадение слов в колонках "Области деятельности" и "Подходящие типы проектов" присуждается по 1 баллу'),
                    html.Br(),
